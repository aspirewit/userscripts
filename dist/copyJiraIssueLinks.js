...
// ==/UserScript==
const{$:o}=window,i=window.location.origin,c=`<div id="ghx-copy-links"><img src="${GM_getResourceURL("icon")}" /></div>`,l=function(){const e=o(this).attr("data-issue-key");return`${i}/browse/${e}`},u=()=>{const e=o(".ghx-selected").map(l).get().join("\n");GM_setClipboard(e)},s=()=>{o("#ghx-copy-links").length||o(c).css({alignItems:"center",cursor:"pointer",display:"flex",justifyContent:"center",marginRight:"16px"}).click(u).insertAfter("#ghx-share")};o(()=>r(()=>o("#ghx-share").length,s))}]);